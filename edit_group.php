...
<?php
  ...
  if(!$e_group){
    $session->msg("d","ID du groupe manquant.");
    redirect('group.php');
  }
?>
<?php
        ...
        <div class="form-group">
          <label for="status">Status</label>
              <select class="form-control" name="status">
                <option <?php if($e_group['group_status'] === '1') echo 'selected="selected"';?> value="1"> Activer </option>
                <option <?php if($e_group['group_status'] === '0') echo 'selected="selected"';?> value="0">Désactiver</option>
              </select>
        </div>
